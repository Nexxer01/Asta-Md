...
async function sendWelcome(_0x50ffa3, _0x3417a5 = "", _0x27d774 = "", _0x3fa550 = "", _0x7317df = "msg", _0x495ef9 = false) {
  try {
    ...
    if (_0x3417a5) {
      ...
      let _0x23df3f = _0x3417a5.replace(/@user|&user/gi, "@" + _0x50ffa3.senderNum).replace(/@name|&name/gi, _0x50ffa3.senderName || "_").replace(/@gname|&gname/gi, "").replace(/@desc|&desc/gi, "").replace(/@count|&count/gi, "1").replace(/@pp|&pp|@gpp|&gpp|@context|&context/g, "").replace(/@time|&time/gi, _0x50ffa3.time).replace(/@date|&date/gi, _0x50ffa3.date).replace(/@bot|&bot/gi, "" + Config.botname).replace(/@owner|&owner/gi, "" + Config.ownername).replace(/@caption|&caption/gi, caption).replace(/@gurl|@website|&gurl|&website|@link|&link/gi, gurl).replace(/@myyt|&myyt/gi, "https://www.instagram.com/nexxer_sama").replace(/@telegram|&telegram/gi, global.telegram || "https://www.instagram.com/nexxer_sama").replace(/@channel|@yt_channel|&channel|&yt_channel/gi, global.YT_PRODUCT || global.YT_CHANNEL || global.YT_PROMOTE || global.YT || "https://www.instagram.com/nexxer_sama").replace(/@runtime|&runtime|@uptime|&uptime/gi, "" + runtime(process.uptime())).trim();
      try {
...
setMention.cmd = async (_0x501ec5, _0x2a1c43 = "") => {
  try {
    ...
    if (_0x2a1c43 === "get" || _0x2a1c43 === "info" || !_0x2a1c43 && _0x22516b.status && _0x22516b.get) {
      ...
      _0x501ec5.reply("_Contact Nexxer Sama to set mention message https://wa.me/916003951523", {}, "smd");
